...
def log_final_group_status(test_group_id, **kwargs):
    ...
    try:
        ...
        final_message = f"Group run completed. Status: {final_status}. Failed tests: {failed_count + errored_count} out of {total_tests}."
...
with DAG(
    dag_id="test_group_77206e63_5e23_4ee1_bc13_0408851493d2",
    ...
    # NEW TASK: This task runs after all test case tasks complete
    log_final_status_task = PythonOperator(
        task_id="log_final_group_status",
        python_callable=log_final_group_status,
        op_kwargs={
            'test_group_id': '77206e63-5e23-4ee1-bc13-0408851493d2',
        }
    )
    ...
    # Set the dependency for the final task
    # This line ensures the final logging task runs only after the last test case task
    t2 >> log_final_status_task