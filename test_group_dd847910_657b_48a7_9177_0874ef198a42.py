...
def log_final_group_status(test_group_id, **kwargs):
    ...
    try:
        ...
        query = 
        SELECT TEST_CASE_ID, TEST_NAME, RUN_STATUS, RUN_MESSAGE 
        FROM DEV_DB.PUBLIC.TEST_CASE_LOGS 
...
with DAG(
    dag_id="test_group_dd847910_657b_48a7_9177_0874ef198a42",
    ...
    start_logging_task = PythonOperator(
        ...
        op_kwargs={'test_group_id': 'dd847910-657b-48a7-9177-0874ef198a42'},
    )
